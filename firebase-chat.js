(function () {
  ...
  var firebaseConfig = {
    apiKey: "AIzaSyBlKQoNrabCrJHqNPyvnTGNd0XEbh6N4bA",
    authDomain: "fir-chat-b6b17.firebaseapp.com",
    databaseURL: "https://fir-chat-b6b17-default-rtdb.firebaseio.com",
    projectId: "fir-chat-b6b17",
    storageBucket: "fir-chat-b6b17.appspot.com",
    messagingSenderId: "889527649032",
    appId: "1:889527649032:web:18c32e5cb8c278fdb022bd"
  };
  // Initialize Firebase
  ...
  login.addEventListener('click', (e) => {
    ...
    promise.then((resp) => {
      ...
      userNameDisplay.innerHTML = currentUserEmail;
